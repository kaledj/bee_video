...
def show_video(filename):
    ...
    while ret and cv2.waitKey(int(1/fps*1000)) != 27:
        ...
        cv2.imshow("Grayscale input", frame)
        # Update background model
        #currentBgModel = bgModel.copy()
        segmentation.updateBGM_alr(bgModel, dFrame, frameGray, threshold, fgmask)
        #print "BG Change:", currentBgModel.astype(np.int) - bgModel.astype(np.int)
